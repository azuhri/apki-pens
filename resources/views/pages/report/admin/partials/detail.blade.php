<div class="card-header border-bottom border-bottom-4">
    <div class="d-flex flex-column">
        ...
        <div class="d-flex flex-column">
            ...
            @if ($data->approved_by)
                <div class="mt-2">
                    <p>{{$data->status == "DIPROSES"?  "Diproses" : "Diselesaikan"}} oleh <span class="text-primary font-weight-bold">{{$data->approvedBy->name}} - ({{$data->approvedBy->email}})</span></p>
                </div>
            @endif
        </div>
    </div>
    ...
    <div class="row position-relative">
        ...
        <div class="col-11">
            ...
            <div class="d-flex justify-content-end my-2">
                @if ($data->status == "BARU")
                    <button onclick="updateStatus({{$data->id}}, 'DIPROSES')" class="btn btn-primary">Proses Laporan</button>
